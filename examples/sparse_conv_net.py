...
class SparseConvExperiment(DepthCompletionExperiment):
    def __init__(self):
        ...
        self.parameters.dataset_train['input'] = os.path.join("/Users/Hall/Documents/GitHub/depth_completion","datasets", "sparse_train.dataset")
        self.parameters.dataset_train['label'] = os.path.join("/Users/Hall/Documents/GitHub/depth_completion","datasets", "dense_train.dataset")

        self.parameters.dataset_val['input'] = os.path.join("/Users/Hall/Documents/GitHub/depth_completion","datasets", "sparse_val.dataset")
        self.parameters.dataset_val['label'] = os.path.join("/Users/Hall/Documents/GitHub/depth_completion","datasets", "dense_val.dataset")
        ...
        self.parameters.log_dir = '/Users/Hall/Documents/GitHub/depth_completion/logs/sparse_conv_net/'
